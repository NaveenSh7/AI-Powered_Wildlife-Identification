...
const Footer = () => {
  return (
    <>
      <div className="container mx-auto px-4 mb bg-[#6A9C89]">
        <div className="flex flex-wrap text-left lg:text-left ">
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="flex flex-wrap items-top mb-6 mt-8">
              <div className="w-full lg:w-4/12 px-4 ml-auto">
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <a
                      className=" text-blackhover:text-blueGray-800 font-semibold block pb-2 text-sm"
